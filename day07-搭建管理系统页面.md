---
title: day07-搭建管理系统页面
date: 2019-04-27 14:36:42
categories:
tags:
---
...
每次在C盘寻找hosts文件并修改是非常麻烦的，给大家推荐一个快捷修改host的工具，在课前资料中可以找到：
 ...
 ![1526014883706](day07-搭建管理系统页面/1526014883706.png)

效果：

 ![1526015022365](day07-搭建管理系统页面/1526015022365.png)
...
现在，ping一下域名试试是否畅通：
 ...
 ![1526015211298](day07-搭建管理系统页面/1526015211298.png)
...
![1526187409033](day07-搭建管理系统页面/1526187409033.png)
...
![1526016663674](day07-搭建管理系统页面/1526016663674.png)
...
![img](day07-搭建管理系统页面/0C36B84E.gif) 

我们在本地安装一台nginx：

 ![1526016829605](day07-搭建管理系统页面/1526016829605.png)

目录结构：

 ![1526188477802](day07-搭建管理系统页面/1526188477802.png)
...
示例：
 ...
 ![1526188831504](day07-搭建管理系统页面/1526188831504.png)
...
![1526017010289](day07-搭建管理系统页面/1526017010289.png)

现在实现了域名访问网站了，中间的流程是怎样的呢？

![1526189945180](day07-搭建管理系统页面/1526189945180.png)
...
![1525999005260](day07-搭建管理系统页面/1525999005260.png)
...
首先导入课前资料提供的sql：
 ...
 ![1525999677772](day07-搭建管理系统页面/1525999677772.png)

我们先看商品分类表：

 ![1525999774439](day07-搭建管理系统页面/1525999774439.png)
...
![1525999250932](day07-搭建管理系统页面/1525999250932.png)

商品分类之间是会有层级关系的，采用树结构去展示是最直观的方式。

一起来看页面，对应的是/pages/item/Category.vue：

 ![1526000313361](day07-搭建管理系统页面/1526000313361.png)
...
![1526004282868](day07-搭建管理系统页面/1526004282868.png)
...
这是因为，我们有一个全局的配置文件，对所有的请求路径进行了约定：
 ...
 ![1526005059829](day07-搭建管理系统页面/1526005059829.png)

 ![1526005071153](day07-搭建管理系统页面/1526005071153.png)

路径是localhost，并且默认加上了/api的前缀，这恰好与我们的网关设置匹配，我们只需要把地址改成网关的地址即可,因为我们使用了nginx反向代理，这里可以写域名：

 ![1526017217473](day07-搭建管理系统页面/1526017217473.png)

再次查看页面，发现地址已经变成了正确的地址了：

 ![1526017265625](day07-搭建管理系统页面/1526017265625.png)
...
结构：
 ...
 ![1526006869782](day07-搭建管理系统页面/1526006869782.png)
...
在刚才页面发起的请求中，我们就能得到绝大多数信息：
 ...
 ![1527473096007](day07-搭建管理系统页面/1527473096007.png)
...
我们不经过网关，直接访问：
 ...
 ![1526009785484](day07-搭建管理系统页面/1526009785484.png)

然后试试网关是否畅通：

  ![1526017422684](day07-搭建管理系统页面/1526017422684.png)

一切OK！

然后刷新页面查看：

![1526017362418](day07-搭建管理系统页面/1526017362418.png)
...
当浏览器发现发现的ajax请求是简单请求时，会在请求头中携带一个字段：`Origin`.
 ...
 ![1526019242125](day07-搭建管理系统页面/1526019242125.png)
...
结构：
 ...
 ![1526021505774](day07-搭建管理系统页面/1526021505774.png)
...
访问正常：
 ...
 ![1526021419016](day07-搭建管理系统页面/1526021419016.png)

页面也OK了：

![1526021447335](day07-搭建管理系统页面/1526021447335.png)
...
![1526021968036](day07-搭建管理系统页面/1526021968036.png)
...
为了方便看到效果，我们新建一个MyBrand.vue（注意先停掉服务器），从0开始搭建。
 ...
 ![1526023142926](day07-搭建管理系统页面/1526023142926.png)
...
![1526023276997](day07-搭建管理系统页面/1526023276997.png)

打开服务器，再次查看页面：

![1526023471428](day07-搭建管理系统页面/1526023471428.png)
...
![1526023540226](day07-搭建管理系统页面/1526023540226.png)
...
![1526023837773](day07-搭建管理系统页面/1526023837773.png)
...
- loading：boolean类型，true：代表数据正在加载，会有进度条。false：数据加载完毕。
  ...
  ![1526029254159](day07-搭建管理系统页面/1526029254159.png)
...
![1526029445561](day07-搭建管理系统页面/1526029445561.png)
...
![1526029907794](day07-搭建管理系统页面/1526029907794.png)
...
![1526030236992](day07-搭建管理系统页面/1526030236992.png)

然后在官方文档中找到按钮的用法：

![1526030329303](day07-搭建管理系统页面/1526030329303.png)
...
![1526030431704](day07-搭建管理系统页面/1526030431704.png)

> #### 新增按钮

因为新增根某个品牌无关，是独立的，因此我们可以放到表格的外面：

 ![1526030663178](day07-搭建管理系统页面/1526030663178.png)

效果：

![1526030540341](day07-搭建管理系统页面/1526030540341.png)
...
![1526031159242](day07-搭建管理系统页面/1526031159242.png)
...
![1526031720583](day07-搭建管理系统页面/1526031720583.png)
...
![1526031897445](day07-搭建管理系统页面/1526031897445.png)
...
![1526032177687](day07-搭建管理系统页面/1526032177687.png)

发现输入框变的超级长！！！

这个时候，我们可以使用Vuetify提供的一个空间隔离工具：

![1526032321057](day07-搭建管理系统页面/1526032321057.png)
...
![1526032398630](day07-搭建管理系统页面/1526032398630.png)
...
查看textfiled的文档，发现：
 ...
 ![1526033007616](day07-搭建管理系统页面/1526033007616.png)
...
![1526033167381](day07-搭建管理系统页面/1526033167381.png)
...
![1526033439890](day07-搭建管理系统页面/1526033439890.png)
...
![1526033500219](day07-搭建管理系统页面/1526033500219.png)
...
- 响应结果：分页结果一般至少需要两个数据
  ...
  另外，这个PageResult以后可能在其它项目中也有需求，因此我们将其抽取到`ly-common`中，提高复用性：
   ...
   ![1526046620269](day07-搭建管理系统页面/1526046620269.png)
...
通过浏览器访问试试：http://api.leyou.com/api/item/brand/page
 ...
 ![1526047708748](day07-搭建管理系统页面/1526047708748.png)
...
![1526033988251](day07-搭建管理系统页面/1526033988251.png)
...
而在我们的项目中，已经引入了axios，并且进行了简单的封装，在src下的http.js中：
 ...
 ![1526034150067](day07-搭建管理系统页面/1526034150067.png)
...
- http.js中导入了config的配置，还记得吗？
    ...
    ![1526041205846](day07-搭建管理系统页面/1526041205846.png)
...
我们在组件`MyBrand.vue`的getDataFromServer方法，通过$http发起get请求，测试查询品牌的接口，看是否能获取到数据：
   ...
   ![1526048221750](day07-搭建管理系统页面/1526048079191.png)

网络监视：

 ![1526048143014](day07-搭建管理系统页面/1526048143014.png)

控制台结果：

![1526048275064](day07-搭建管理系统页面/1526048275064.png)
...
而页面中分页信息应该是在pagination对象中，我们通过浏览器工具，查看pagination中有哪些属性：
 ...
 ![](day07-搭建管理系统页面/1526042136135.png)
...
查看网络请求：
 ...
 ![1526049810351](day07-搭建管理系统页面/1526049810351.png)

效果：

![1526049139244](day07-搭建管理系统页面/1526049139244.png)
...
虽然点击分页，不会发起请求，但是通过浏览器工具查看，会发现pagination对象的属性一直在变化：
 ...
 ![](day07-搭建管理系统页面/9.gif)

我们可以利用Vue的监视功能：watch，当pagination发生改变时，会调用我们的回调函数，我们在回调函数中进行数据的查询即可！

具体实现：

![1526049643506](day07-搭建管理系统页面/1526049643506.png)

成功实现分页功能：

![1526049720200](day07-搭建管理系统页面/1526049720200.png)
...
分页实现了，过滤也很好实现了。过滤字段对应的是search属性，我们只要监视这个属性即可:
 ...
 ![1526049939985](day07-搭建管理系统页面/1526049939985.png)

查看网络请求：

 ![1526050032436](day07-搭建管理系统页面/1526050032436.png)

页面结果：

![1526050071442](day07-搭建管理系统页面/1526050071442.png)
