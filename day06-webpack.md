...
为了让接下来的功能比较清晰，我们先新建一个文件夹：src:
 ...
 ![1525868223969](day06-webpack/1525868223969.png)

然后新建一个HTML文件，作为入口：index.html

 ![1525868284332](day06-webpack/1525868284332.png)
...
样式：
 ...
 ![1525868623712](day06-webpack/1525868623712.png)
...
接下来我们来实现登录组件，以前我们都是写在一个文件中，但是为了复用性，开发中都会把组件放如独立的JS文件中，我们新建一个login.js
 ...
 ![1525868736799](day06-webpack/1525868736799.png)
...
新建单文件组件：register.js
 ...
 ![1525869269916](day06-webpack/1525869269916.png)
...
效果：
 ...
 ![1525869621647](day06-webpack/1525869621647.png)
...
使用npm安装：`npm install vue-router --save` 
 ...
 ![1525870170532](day06-webpack/1525870170532.png)
...
![1525866284055](day06-webpack/1525866284055.png)

官网给出的解释：

![1525866410437](day06-webpack/1525866410437.png)
...
![1525873000269](day06-webpack/1525873000269.png)

此时，我们注意下项目中文件夹下，会有一个package.json文件。（其实早就有了）

 ![1525873145475](day06-webpack/1525873145475.png)

打开文件，可以看到我们之前用npm安装过的文件都会出现在这里：

 ![1525873343908](day06-webpack/1525873343908.png)
...
接下来，我们编写一个webpack的配置，来指定一些打包的配置项。配置文件的名称，默认就是webpack.config.js，我们放到hello-vue的根目录：
 ...
 ![1525873610812](day06-webpack/1525873610812.png)
...
我们新建一个js，把index.html中的部分内容进行集中，然后在index.html中引用这个js不就OK了！
 ...
 ![1525874002350](day06-webpack/1525874002350.png)
...
出口，就是输出的目的地。一般我们会用一个dist目录，作为打包输出的文件夹：
 ...
 ![1525875474187](../../%E8%AF%BE%E5%90%8E/day05-Vue/day06-webpack/1525875474187.png)
...
![1525875749502](day06-webpack/1525875749502.png)

随后，查看dist目录：

 ![1525875792078](day06-webpack/1525875792078.png)

尝试打开build.js，你根本看不懂：

![1525876060602](day06-webpack/1525876060602.png)
...
然后运行：
 ...
 ![1525875932114](day06-webpack/1525875932114.png)
...
我们来编写一段CSS代码，对index的样式做一些美化：
 ...
 ![1525877099220](day06-webpack/1525877099220.png)
...
![1525877313725](day06-webpack/1525877313725.png)

此时，在package.json中能看到新安装的：

 ![1525877634350](day06-webpack/1525877634350.png)
...
再次输入打包指令：`npx webpack --config webpack.config.js`
 ...
 ![1525877746191](day06-webpack/1525877746191.png)

效果：

 ![1525877882425](day06-webpack/1525877882425.png)
...
我们可以把webpack的命令编入其中：
 ...
 ![1525878015255](day06-webpack/1525878015255.png)

以后，如果要打包，就可以直接输入：`npm run build`即可。

- `npm run` ：执行npm脚本，后面跟的是脚本的名称`build`

![1525878133337](day06-webpack/1525878133337.png)
...
2）将原来HTML中的引入js代码删除：
  ...
  ![1527390662284](day06-webpack/1527390662284.png)

3）再次打包：`npm run build`

![1525879126478](day06-webpack/1525879126478.png)

4）查看dist目录：

 ![1525879160040](day06-webpack/1525879160040.png)
...
```
 ...
 ![1525912021845](day06-webpack/1525912021845.png)

4）效果：

 ![1525912255757](day06-webpack/1525912255757.png)
...
我们新建一个module：
 ...
 ![1525912928592](day06-webpack/1525912928592.png)

打开终端并进入目录：

 ![1525913049617](day06-webpack/1525913049617.png)

用vue-cli命令，快速搭建一个webpack的项目：`vue init webpack`

![1525913141066](day06-webpack/1525913141066.png)

 ![1525913197139](day06-webpack/1525913197139.png)

前面几项都走默认或yes

下面这些我们选no

 ![1525913230564](day06-webpack/1525913230564.png)

最后，再选yes，使用 npm安装

 ![1525913263487](day06-webpack/1525913263487.png)



![1525913307569](day06-webpack/1525913307569.png)
...
安装好的项目结构：
 ...
 ![1525913435086](day06-webpack/1525913435086.png)



入口文件：

![1525913687860](day06-webpack/1525913687860.png)
...
![1525914072353](day06-webpack/1525914072353.png)
...
![1525914618504](day06-webpack/1525914618504.png)
...
我们执行`npm run dev` 或者 `npm start` 都可以启动项目：
 ...
 ![1525914808164](day06-webpack/1525914808164.png)



页面：

![1525914871848](day06-webpack/1525914871848.png)
...
后台项目相对复杂，为了有利于教学，我们不再从0搭建项目，而是直接使用课前资料中给大家准备好的源码：
 ...
 ![1525955154460](day06-webpack/1525955154460.png)

我们解压缩，放到工作目录中：

 ![1525955615381](day06-webpack/1525955615381.png)



然后在eclipse中导入新的工程：

 ![1525955644681](day06-webpack/1525955644681.png)

选中我们的工程：

 ![1525955709334](day06-webpack/1525955709334.png)



这正是一个用vue-cli构建的webpack工程，是不是与昨天的一样：

 ![1525955811416](day06-webpack/1525955811416.png)

> ## 安装依赖

你应该注意到，这里并没有node_modules文件夹，方便给大家下发，已经把依赖都删除了。不过package.json中依然定义了我们所需的一切依赖：

 ![1525956016683](day06-webpack/1525956016683.png)

我们只需要通过命令来安装所需依赖即可。打开终端，进入项目目录，输入：`npm install`

 ![1525957503521](day06-webpack/1525957503521.png)
...
```
 ...
 ![1525957604219](day06-webpack/1525957604219.png)

发现默认的端口是9001。访问：http://localhost:9001

会自动进行跳转：

![1525958950616](day06-webpack/1525958950616.png)
...
![1525960652724](day06-webpack/1525960652724.png)
...
![1525959769978](day06-webpack/1525959769978.png)
...
![1525960312939](day06-webpack/1525960312939.png)



我们重点关注`UI components`即可，里面有大量的UI组件，我们要用的时候再查看，不用现在学习，先看下有什么：

 ![1525961862771](day06-webpack/1525961862771.png)



 ![1525961875288](day06-webpack/1525961875288.png)
...
![1525962755237](day06-webpack/1525962755237.png)
...
![1525964023585](day06-webpack/1525964023585.png)
...
![1525965105184](day06-webpack/1525965105184.png)

一个典型的三块布局。包含左，上，中三部分：

 ![1525965779366](day06-webpack/1525965779366.png)
