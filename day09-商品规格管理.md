...
如下图所示：
 ...
 ![1526088168565](day09-商品规格管理/1526088168565.png)
...
![1526089506566](day09-商品规格管理/1526089506566.png)
...
> 先整体看一下：
 ...
 ![1526092693138](day09-商品规格管理/1526092693138.png)
...
> 接下来是params：
 ...
 ![1526093111370](day09-商品规格管理/1526093111370.png)
...
上面的截图中所有属性都是全局属性，我们来看看内存，应该是特有属性：
  ...
  ![1526262641446](day09-商品规格管理/1526262641446.png)
...
![1526095296462](day09-商品规格管理/1526095296462.png)

因为规格是跟商品分类绑定的，因此首先会展现商品分类树，并且提示你要选择商品分类，才能看到规格参数的模板。一起了解下页面的实现：

![1526095548672](day09-商品规格管理/1526095548672.png)
...
接下来，看看Vue实例中data定义了哪些属性，对页面会产生怎样的影响：
 ...
 ![1526287774316](day09-商品规格管理/1526287774316.png)
...
当我们点击树节点时，要将`v-dialog`打开，因此必须绑定一个点击事件：
 ...
 ![1526095959539](day09-商品规格管理/1526095959539.png)
...
- 返回结果：页面是直接把`resp.data`赋值给了specifications：
  ...
  ![1526104087329](day09-商品规格管理/1526104087329.png)
...
目前，我们数据库只提供了3条规格参数信息：
 ...
 ![1526104551227](day09-商品规格管理/1526104551227.png)

我们访问：http://api.leyou.com/api/item/spec/76

 ![1526104475036](day09-商品规格管理/1526104475036.png)

然后在后台系统中测试：

![1526104599452](day09-商品规格管理/1526104599452.png)



当我们点击一个还不存在的规格参数的商品分类：

![1526104769276](day09-商品规格管理/1526104769276.png)
...
> 整体来看：
 ...
 ![1526262279963](day09-商品规格管理/1526262279963.png)

整体看上去与规格参数表中的数据一样，也是一个数组，并且分组，每组下有多个参数

> 展开一组来看

 ![1526262389233](day09-商品规格管理/1526262389233.png)
...
刚才看到的是全局属性，那么特有属性在这个字段中如何存储呢？
 ...
 ![1526263214087](day09-商品规格管理/1526263214087.png)
...
在哪里会用到这个字段的值呢，商品详情页的规格参数信息中：
 ...
 ![1526267700765](day09-商品规格管理/1526267700765.png)
...
来看数据格式：
 ...
 ![1526267952827](day09-商品规格管理/1526267952827.png)
...
![1527823423289](day09-商品规格管理/1527823423289.png)
...
![1526268595873](day09-商品规格管理/1526268595873.png)
...
模板代码在分别在Goods.vue
 ...
 ![1526269215532](day09-商品规格管理/1526269215532.png)

> ## 从0开始

接下来，我们自己来实现一下，新建两个组件：MyGoods.vue和MyGoodsForm.vue

 ![1526269362233](day09-商品规格管理/1526269362233.png)
...
然后修改menu.js,新建一个菜单：
 ...
 ![1526269555118](day09-商品规格管理/1526269555118.png)

修改router/index.js，添加一个路由：

 ![1526269615639](day09-商品规格管理/1526269615639.png)

预览一下：

 ![1526269739468](day09-商品规格管理/1526269739468.png)
...
![1526272476614](day09-商品规格管理/1526272476614.png)
...
![1526272537552](day09-商品规格管理/1526272537552.png)
...
另外，似乎页面少了对上下架商品的过滤，在原始效果图中是有的：
 ...
 ![1526277614649](day09-商品规格管理/1526277614649.png)

这在Vuetify中是一组按钮，我们查看帮助文档：

 ![1526277713391](day09-商品规格管理/1526277713391.png)
...
刷新页面，查看效果：
 ...
 ![1526280777975](day09-商品规格管理/1526280777975.png)
...
新增商品窗口：
 ...
 ![1526268739827](../../../%E4%B9%90%E4%BC%98%E5%95%86%E5%9F%8E/%E7%AC%94%E8%AE%B0/day08/day09-商品规格管理/1526268739827.png)
...
不过弹窗中没有任何数据：
 ...
 ![1526281134046](day09-商品规格管理/1526281134046.png)
...
![1526281659782](day09-商品规格管理/1526281659782.png)

其基本结构如图：

![1526282309386](day09-商品规格管理/1526282309386.png)
...
![1526283729193](day09-商品规格管理/1526283729193.png)
...
![1526283971416](day09-商品规格管理/1526283971416.png)
...
改造MyGoods的对话框组件：
  ...
  ![1526285123845](day09-商品规格管理/1526285123845.png)

查看页面：

![1526285086042](day09-商品规格管理/1526285086042.png)
...
我们先在父组件定义一个step属性：
 ...
 ![1526285364638](day09-商品规格管理/1526285364638.png)
...
子组件中接收属性：
 ...
 ![1526285994382](day09-商品规格管理/1526285994382.png)
...
效果：
 ...
 ![1526290196168](day09-商品规格管理/1526290196168.png)

查看goods的属性，三级类目都在：

 ![1526290263252](day09-商品规格管理/1526290263252.png)
...
品牌不分级别，使用普通下拉选框即可。我们查看官方文档的下拉选框说明：
 ...
 ![1526287929674](day09-商品规格管理/1526287929674.png)
...
我们定义一个属性，保存品牌的待选项信息：
 ...
 ![1526289926110](day09-商品规格管理/1526289926110.png)
...
> #### 测试效果
 ...
 ![1526290461916](day09-商品规格管理/1526290461916.png)
...
![1526290761721](day09-商品规格管理/1526290761721.png)
...
![1526290914491](day09-商品规格管理/1526290914491.png)
...
![1526291232678](day09-商品规格管理/1526291232678.png)
...
不过这个组件有个小问题，就是图片上传的无法直接上传到后台，因此我们对其进行了封装，支持了图片的上传。
 ...
 ![1526296083605.png](day09-商品规格管理/1526296083605.png)
...
![1526297276667](day09-商品规格管理/1526297276667.png)
...
首先，我们在data中定义变量，记录查询到的规格参数模板：
 ...
 ![1526297766476](day09-商品规格管理/1526297766476.png)

然后，我们通过watch监控goods.categories的变化，然后去查询规格：

  ![1526375545366](day09-商品规格管理/1526375545366.png)

查看是否查询到：

 ![1526297980403](day09-商品规格管理/1526297980403.png)
...
规格参数中的属性有一些需要我们特殊处理：
 ...
 ![1526298277201](day09-商品规格管理/1526298277201.png)
...
效果：
 ...
 ![1526302470344](day09-商品规格管理/1526302470344.png)
...
首先：我们在data中新建一个属性，保存特有的规格参数：
 ...
 ![1526306568822](day09-商品规格管理/1526306568822.png)
...
查看数据：
 ...
 ![1526306826026](day09-商品规格管理/1526306826026.png)
...
我们的目标效果是这样的：
 ...
 ![1526307835157](day09-商品规格管理/1526307835157.png)
...
![1526308151513](day09-商品规格管理/1526308151513.png)



测试下，勾选checkbox或填写文本会发生什么：

 ![1526308483766](day09-商品规格管理/1526308483766.png)

看下规格模板的值：

 ![1526308513342](day09-商品规格管理/1526308513342.png)
...
![1526309463115](day09-商品规格管理/1526309463115.png)
...
而删除文本框相对就比较简单了，只要在文本框末尾添加一个按钮，添加点击事件即可，代码：
 ...
 ![1526310720065](day09-商品规格管理/1526310720065.png)
...
![1526311110498](day09-商品规格管理/1526311110498.png)
...
![1526311330409](day09-商品规格管理/1526311330409.png)
...
结果：
 ...
 ![1526354069684](day09-商品规格管理/1526354069684.png)
...
结果：
 ...
 ![1526355132141](day09-商品规格管理/1526355132141.png)
...
结果：
 ...
 ![1526356312119](day09-商品规格管理/1526356312119.png)
...
查看生成的数据：
 ...
 ![1526363824808](day09-商品规格管理/1526363824808.png)
...
![1526364758744](day09-商品规格管理/1526364758744.png)
...
![1526365039421](day09-商品规格管理/1526365039421.png)
...
![1526366340741](day09-商品规格管理/1526366340741.png)

用法也非常简单，添加一个template，把其slot属性指定为expand即可：

![1526366667064](day09-商品规格管理/1526366667064.png)

效果：

![1526366997943](day09-商品规格管理/1526366997943.png)



接下来就是我们的图片上传组件：v-upload

![1526367719809](day09-商品规格管理/1526367719809.png)
...
![1526366187195](day09-商品规格管理/1526366187195.png)
...
![1526391630336](day09-商品规格管理/1526391630336.png)
