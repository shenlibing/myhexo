...
![1526725119663](day13-搜索过滤/1526725119663.png)
...
看页面：
 ...
 ![1526738120021](day13-搜索过滤/1526738120021.png)
...
![1532259453938](day13-搜索过滤/1532259453938.png)
...
来看下页面的展示效果：
 ...
 ![1526742664217](day13-搜索过滤/1526742664217.png)

虽然分类、品牌内容都不太一样，但是结构相似，都是key和value的结构。

而且页面结构也极为类似：

 ![1526742817804](day13-搜索过滤/1526742817804.png)
...
![1532261937404](day13-搜索过滤/1532261937404.png)

然后刷新页面，通过浏览器工具，查看封装的结果：

![1532260781128](day13-搜索过滤/1532260781128.png)
...
首先看页面原来的代码：
 ...
 ![1526803362517](day13-搜索过滤/1526803362517.png)
...
![1532264524663](day13-搜索过滤/1532264524663.png)
...
![1526805322441](day13-搜索过滤/1526805322441.png)
...
![1532270316330](day13-搜索过滤/1532270316330.png)
...
然后，我们需要根据商品分类，查询所有可用于搜索的规格参数：![1532270455414](day13-搜索过滤/1532270455414.png)
...
![1532270506198](day13-搜索过滤/1532270506198.png)



> ### 解析聚合结果

![1532270553350](day13-搜索过滤/1532270553350.png)
...
![1532270167684](day13-搜索过滤/1532270167684.png)
...
![1532271319440](day13-搜索过滤/1532271319440.png)

最后的结果：

![1526836508277](day13-搜索过滤/1526836508277.png)
...
![1532271362148](day13-搜索过滤/1532271362148.png)

我们在data中定义变量，记录展开或隐藏的状态：

![1532271577293](day13-搜索过滤/1532271577293.png)

然后在按钮绑定点击事件，以改变show的取值：

![1532272309322](day13-搜索过滤/1532272309322.png)



在展示规格时，对show进行判断：

![1532272262743](day13-搜索过滤/1532272262743.png)
...
![1532273487583](day13-搜索过滤/1532273487583.png)

要注意，在created构造函数中会对search进行初始化，所以要在构造函数中对filter进行初始化：

 ![1526902467385](day13-搜索过滤/1526902467385.png)
...
![1532272879418](day13-搜索过滤/1532272879418.png)
...
![1532273144046](day13-搜索过滤/1532273144046.png)



我们刷新页面，点击后通过浏览器功能查看`search.filter`的属性变化：

![1532274670784](day13-搜索过滤/1532274670784.png)
...
![1532274821104](day13-搜索过滤/1532274821104.png)
...
我们需要在请求类：`SearchRequest`中添加属性，接收过滤属性。过滤属性都是键值对格式，但是key不确定，所以用一个map来接收即可。
 ...
 ![1526910290497](day13-搜索过滤/1526910290497.png)
...
![1526910653795](day13-搜索过滤/1526910653795.png)
...
所以，我们对原来的基本查询进行改造：
 ...
 ![1526910768974](day13-搜索过滤/1526910768974.png)
...
我们先不点击过滤条件，直接搜索手机：
 ...
 ![1526910966728](day13-搜索过滤/1526910966728.png)
...
接下来，我们点击一个过滤条件：
 ...
 ![1526911057839](day13-搜索过滤/1526911057839.png)

得到的结果：

 ![1526911090064](day13-搜索过滤/1526911090064.png)
...
当用户选择一个商品分类以后，我们应该在过滤模块的上方展示一个面包屑，把三级商品分类都显示出来。
 ...
 ![1526912181355](day13-搜索过滤/1526912181355.png)
...
测试：
 ...
 ![1526912781014](day13-搜索过滤/1526912781014.png)
...
![1526914910479](day13-搜索过滤/1526914910479.png)

渲染：

 ![1528416823546](day13-搜索过滤/1528416823546.png)



刷新页面：

 ![1526914954839](day13-搜索过滤/1526914954839.png)
...
![1526911364625](day13-搜索过滤/1526911364625.png)

我们知道，所有已选择过滤项都保存在`search.filter`中，因此在页面遍历并展示即可。

但这里有个问题，filter中数据的格式：

 ![1526911311273](day13-搜索过滤/1526911311273.png)
...
![1526911811998](day13-搜索过滤/1526911811998.png)
...
![1526915075037](day13-搜索过滤/1526915075037.png)
...
你必须先知道用户选择了什么。用户选择的项保存在`search.filter`中：
 ...
 ![1526915191753](day13-搜索过滤/1526915191753.png)
...
![1526916315470](day13-搜索过滤/1526916315470.png)

刷新页面：

![1526916538925](day13-搜索过滤/1526916538925.png)



最后发现，还剩下一堆没选过的。但是都只有一个可选项，此时再过滤没有任何意义，应该隐藏，所以，在刚才的过滤条件中，还应该添加一条：如果只剩下一个可选项，不显示

![1526916815264](day13-搜索过滤/1526916815264.png)



![1526916838222](day13-搜索过滤/1526916838222.png)
...
![1526955150293](day13-搜索过滤/1526955150293.png)
